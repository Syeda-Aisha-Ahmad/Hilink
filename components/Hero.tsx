    ...
    return (
        <section className='mx-auto max-w-[1440px] px-6 lg:px-20 3xl:px-0 flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row'>
            ...
            <div className="relative z-20 flex flex-1 flex-col xl:w-1/2">
                ...
                <div className='flex flex-col md:flex-row w-full gap-3 sm-flex-row'>
                    <Button
                        type="button"
                        title='Download App'
                        className='border-green-50 bg-green-50 px-8 py-5 text-white'
                    />
                    ...
                    <Button
                        ...
                        title='How we work?'
                        icon="/play.svg"
                        className='border-white bg-white px-8 py-3 text-gray-90'
                    />
                </div>
            </div>
